...
test('category pages use matching banner assets', () => {
  ...
  assert.match(page('catagory.html'), /img\/bg-img\/gopro-accessories-premium-v2\.webp/);
  assert.match(page('insta360-camera.html'), /img\/bg-img\/insta360-cameras-premium-v2\.webp/);
  assert.match(page('360accesories.html'), /img\/bg-img\/insta360-accessories-premium-v2\.webp/);
